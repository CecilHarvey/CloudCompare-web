...
#define glBindFramebufferEXT		MANGLE(BindFramebuffer)
...
#define glCheckFramebufferStatusEXT		MANGLE(CheckFramebufferStatus)
...
#define glDeleteFramebuffersEXT		MANGLE(DeleteFramebuffers)
...
#define glFramebufferTexture2DEXT		MANGLE(FramebufferTexture2D)
...
#define glGenFramebuffersEXT		MANGLE(GenFramebuffers)

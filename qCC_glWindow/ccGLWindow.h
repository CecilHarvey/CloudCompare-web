...
public:
	...
	virtual void display3DLabel(const std::string& str, const CCVector3& pos3D, const unsigned char* rgbColor=0);
    virtual void displayText(std::string text, int x, int y, unsigned char align=ALIGN_DEFAULT, unsigned char bkgAlpha=0, const unsigned char* rgbColor=0);
    ...
    **/
	virtual void displayNewMessage(const std::string &message,
									MessagePosition pos,
									bool append=false,
	...
	**/
	...
	void releaseTexture(unsigned texID) {}
	bool supportOpenGLVersion(unsigned openGLVersionFlag) { return true; }
 ...
 public/* slots*/:
	...
	int width() const { return m_glWidth; }
	int height() const { return m_glHeight; }
...
//signals/*public*/:
    ...
    **/
    ...
    //! Signal emmitted when the cube is add (add by zhongzhiwei01)
    void (*newCube)(ccBox* cube);
...
protected:
    ...
    void wheelEvent(SDL_MouseWheelEvent *event);
	...
	**/
    ...
    //! Starts CPU picking process
    int startCPUBasedPointPicking(int centerX, int centerY);

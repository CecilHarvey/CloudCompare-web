...
class QCC_DB_DLL_API ccGLMatrix
#else
class ccGLMatrix
#endif
{
public:
	...
	**/
	...
	/** Adapted from  "Efficiently Building a Matrix to Rotate One Vector to Another"
		By Tomas M�ller, John Hughes, Journal of Graphics Tools, 4(4):1-4, 1999
	...
	**/
	...
	/** \param precision numerical precision
		\return string
	**/
	std::string toString(int precision = 12, char separator = ' ') const;

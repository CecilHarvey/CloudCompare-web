...
public:
    ...
    **/
    ...
    /** \param key meta data unique identifier (case sensitive)
            \return meta data (if any) or an empty string
    **/
    ...
    /** \param key meta-data unique identifier (case sensitive)
            \return success
    **/
    bool removeMetaData(std::string key);

    //! Sets a meta-data element
    /** \param key meta-data unique identifier (case sensitive)
            \param data data
    **/
    void setMetaData(std::string key, std::string data);

    //add by zhongzhiwei01 =======================
	//! set cube global ID
	void setCubeGlobalID(std::string globalID) { m_cubeGlobalID = globalID; }
	//! get cube global ID
	std::string getCubeGlobalID() const { return m_cubeGlobalID; }
    void setCubeDir(bool isConfirmed) {m_dirIsConfirmed = isConfirmed; }
    bool getCubeDir() const {return m_dirIsConfirmed; }
...
protected:
	...
	**/
    ...
    std::string m_cubeGlobalID;
    bool m_dirIsConfirmed;

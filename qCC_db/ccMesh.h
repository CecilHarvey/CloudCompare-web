...
public:
	...
	**/
	...
	bool trianglePicking(const double clickPosX, const double clickPosY, const double *MM, const double *MP, const int *VP, int& nearestTriIndex, double& nearestSquareDist);
